...
import com.sell.repository.OrderDetailRepsitory;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    private OrderDetailRepsitory orderDetailRepsitory;
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        //3.写入订单数据库（orderMaster 和 orderDetail）
            ...
            orderDetailRepsitory.save(orderDetail);
        }
    ...
    public OrderDTO findOne(String orderId) {
        ...
        List<OrderDetail> orderDetailList = orderDetailRepsitory.findByOrderId(orderId);
    ...
    public OrderDTO cancel(OrderDTO orderDTO) {
        ...
        if(update == null){
            log.error("【取消订单】更新失败，orderMaster={}",update);
    ...
    public OrderDTO finish(OrderDTO orderDTO) {
        ...
        OrderMaster update = orderMasterRepository.save(orderMaster);
        if(update == null){
            log.error("【完结订单】更新失败，orderMaster={}",update);
            throw new SellException(ResultEnum.ORDER_UPDATE_FAIL);
        }
        return orderDTO;
    }
    ...
    public OrderDTO paid(OrderDTO orderDTO) {
        ...
        OrderMaster update = orderMasterRepository.save(orderMaster);
        if(update == null){
            log.error("【支付订单】更新失败，orderMaster={}",update);
            throw new SellException(ResultEnum.ORDER_UPDATE_FAIL);
        }
        return orderDTO;
    }
